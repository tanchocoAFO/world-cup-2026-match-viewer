...
export const matches = [
  ...
  { id: 21, matchNumber: 21, date: '2026-06-17', time: '19:00', venue: 'tor', stage: stages.GROUP, group: 'L', description: 'Ghana vs Panama', result: { home: 1, away: 0 } },
  { id: 22, matchNumber: 22, date: '2026-06-17', time: '16:00', venue: 'dal', stage: stages.GROUP, group: 'L', description: 'England vs Croatia', result: { home: 4, away: 2 } },
  ...
  { id: 25, matchNumber: 25, date: '2026-06-18', time: '12:00', venue: 'atl', stage: stages.GROUP, group: 'A', description: 'Czechia vs South Africa', result: { home: 1, away: 1 } },
  { id: 26, matchNumber: 26, date: '2026-06-18', time: '15:00', venue: 'la', stage: stages.GROUP, group: 'B', description: 'Switzerland vs Bosnia and Herzegovina', result: { home: 4, away: 1 } },
  { id: 27, matchNumber: 27, date: '2026-06-18', time: '18:00', venue: 'van', stage: stages.GROUP, group: 'B', description: 'Canada vs Qatar', result: { home: 6, away: 0 } },
  { id: 28, matchNumber: 28, date: '2026-06-18', time: '21:00', venue: 'gdl', stage: stages.GROUP, group: 'A', description: 'Mexico vs South Korea', result: { home: 1, away: 0 } },
  { id: 29, matchNumber: 29, date: '2026-06-19', time: '21:00', venue: 'phi', stage: stages.GROUP, group: 'C', description: 'Brazil vs Haiti', result: { home: 3, away: 0 } },
  { id: 30, matchNumber: 30, date: '2026-06-19', time: '18:00', venue: 'bos', stage: stages.GROUP, group: 'C', description: 'Scotland vs Morocco', result: { home: 0, away: 1 } },
  { id: 31, matchNumber: 31, date: '2026-06-19', time: '00:00', venue: 'sf', stage: stages.GROUP, group: 'D', description: 'Türkiye vs Paraguay', result: { home: 0, away: 1 } },
  { id: 32, matchNumber: 32, date: '2026-06-19', time: '15:00', venue: 'sea', stage: stages.GROUP, group: 'D', description: 'USA vs Australia', result: { home: 2, away: 0 } },
  { id: 33, matchNumber: 33, date: '2026-06-20', time: '16:00', venue: 'tor', stage: stages.GROUP, group: 'E', description: 'Germany vs Ivory Coast', result: { home: 2, away: 1 } },
  { id: 34, matchNumber: 34, date: '2026-06-20', time: '20:00', venue: 'kc', stage: stages.GROUP, group: 'E', description: 'Ecuador vs Curacao', result: { home: 0, away: 0 } },
  { id: 35, matchNumber: 35, date: '2026-06-20', time: '13:00', venue: 'hou', stage: stages.GROUP, group: 'F', description: 'Netherlands vs Sweden', result: { home: 5, away: 1 } },
  { id: 36, matchNumber: 36, date: '2026-06-20', time: '00:00', venue: 'mty', stage: stages.GROUP, group: 'F', description: 'Tunisia vs Japan', result: { home: 0, away: 4 } },
  { id: 37, matchNumber: 37, date: '2026-06-21', time: '18:00', venue: 'mia', stage: stages.GROUP, group: 'H', description: 'Uruguay vs Cabo Verde', result: { home: 2, away: 2 } },
  { id: 38, matchNumber: 38, date: '2026-06-21', time: '12:00', venue: 'atl', stage: stages.GROUP, group: 'H', description: 'Spain vs Saudi Arabia', result: { home: 4, away: 0 } },
  { id: 39, matchNumber: 39, date: '2026-06-21', time: '15:00', venue: 'la', stage: stages.GROUP, group: 'G', description: 'Belgium vs Iran', result: { home: 0, away: 0 } },
  { id: 40, matchNumber: 40, date: '2026-06-21', time: '21:00', venue: 'van', stage: stages.GROUP, group: 'G', description: 'New Zealand vs Egypt', result: { home: 1, away: 3 } },
  { id: 41, matchNumber: 41, date: '2026-06-22', time: '20:00', venue: 'nyj', stage: stages.GROUP, group: 'I', description: 'Norway vs Senegal', result: { home: 3, away: 2 } },
  { id: 42, matchNumber: 42, date: '2026-06-22', time: '17:00', venue: 'phi', stage: stages.GROUP, group: 'I', description: 'France vs Iraq', result: { home: 3, away: 0 } },
  { id: 43, matchNumber: 43, date: '2026-06-22', time: '13:00', venue: 'dal', stage: stages.GROUP, group: 'J', description: 'Argentina vs Austria', result: { home: 2, away: 0 } },
  { id: 44, matchNumber: 44, date: '2026-06-22', time: '23:00', venue: 'sf', stage: stages.GROUP, group: 'J', description: 'Jordan vs Algeria', result: { home: 1, away: 2 } },
  { id: 45, matchNumber: 45, date: '2026-06-23', time: '16:00', venue: 'bos', stage: stages.GROUP, group: 'L', description: 'England vs Ghana', result: { home: 0, away: 0 } },
  { id: 46, matchNumber: 46, date: '2026-06-23', time: '19:00', venue: 'tor', stage: stages.GROUP, group: 'L', description: 'Panama vs Croatia', result: { home: 0, away: 1 } },
  { id: 47, matchNumber: 47, date: '2026-06-23', time: '13:00', venue: 'hou', stage: stages.GROUP, group: 'K', description: 'Portugal vs Uzbekistan', result: { home: 5, away: 0 } },
  { id: 48, matchNumber: 48, date: '2026-06-23', time: '22:00', venue: 'gdl', stage: stages.GROUP, group: 'K', description: 'Colombia vs DR Congo', result: { home: 1, away: 0 } },
